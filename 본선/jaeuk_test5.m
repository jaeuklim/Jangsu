            ...
            if 110000 < bw2_pix_num
                ...
                while 1
                    ...
                    bw_red = ((thdown_red1(1) < src_h & src_h < thup_red1(1)) & (thdown_red1(2) < src_s & src_s < thup_red1(2))) ...            % 빨간색1범위 검출
                           + ((thdown_red2(1) < src_h & src_h < thup_red2(1)) & (thdown_red2(2) < src_s & src_s < thup_red2(2)));               % 빨간색2범위
                    ...
                    if(sum(bw_red, 'all') > 2000)      
                        ...
                        loopBreak = 1;
                        break;                          
                    elseif(sum(bw_red, "all")==0)
                        disp('표식 검출 불가!! 조금뒤로')
                        moveback(droneObj, 'distance', 0.1);                        
                    else
                        disp('표식을 향해 전진중')
        ...
        if (-100 < moveRow && moveRow < 100) && (-100 < moveCol && moveCol < 100)
            ...
            if 110000 < bw2_pix_num
                ...
                while 1
                    ...
                    if(sum(bw_purple, "all")>2000)                    
                        disp('보라색 검출! 착지! 프로그램종료');
                        land(droneObj);                                    
                        return;                        
                    elseif(sum(bw_purple, "all")==0)
                        disp('표식 검출 불가!! 조금뒤로')
                        moveback(droneObj, 'distance', 0.1);                        
                    else
                        disp('표식을 향해 전진중')
